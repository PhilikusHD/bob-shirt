...
dotnet publish BobDesktop\BobDesktop.csproj -c Release -r win-x64 --self-contained true -o "%BASE_DIR%\Desktop"
if errorlevel 1 (
...
dotnet publish BobWASM\BobWASM.csproj -c Release -r browser-wasm --self-contained true -o "%BASE_DIR%\WASM"
if errorlevel 1 (
